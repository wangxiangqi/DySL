...
datareader = DataReader(data_dir='E:/summer_intern/Hua_zheng_Wang/source_localization/TGASI-main/TGASI-main/data/%s/' % args.dataset,
                        rnd_state=rnd_state,
                        folds=n_folds,
...
network_W = torch.load('E:/summer_intern/Hua_zheng_Wang/source_localization/TGASI-main/TGASI-main/data/modelpara_trainingAvailable_abs.pth')['net_params']['weight'].cuda()



dyn_feas = np.load('E:/summer_intern/Hua_zheng_Wang/source_localization/TGASI-main/TGASI-main/data/static_Feas_facebook.npy')
